...
class TweetsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('tweets')->insert([
            ...
            'tweet' => 'gjhgggougjhvfkvdskfdhgfeg egwufgiugefhbjnbkjhgougfuegfuegyfhegjhfbejkhfkjeghfuyegfyuhgfwoehgfhegufy',
            'file' => '/video/warrior.mp4',
            'is_video' => true,
            'comments' => '35',
            'retweets' => '54',
            'likes' => '88',
